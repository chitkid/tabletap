...
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![The Little Furnace landing page: «Заказ со стола. Через секунду он на кухне.», one button onto table 7's menu, the four steps of how it works, opening hours, and the staff entrance in the header](docs/screenshots/landing.png) | ![The Little Furnace menu at table 7: four category chips, and the oven dishes with their drawn plates, allergens and prices in roubles](docs/screenshots/menu.png) |
| **The kitchen board**                                                                                                                                                                                                               | **The admin dashboard**                                                                                                                                             |
| ![The kitchen board mid-service: twenty tickets in Новые, one in Готовятся and one in Готовы, each with its timer, its status and the one control that moves it on](docs/screenshots/kitchen.png)                                   | ![The admin dashboard: 14 orders, 36 040 ₽, 1 min 42 s average time to ready, 13 open tickets, and seven days of paid orders as bars](docs/screenshots/admin.png)   |
